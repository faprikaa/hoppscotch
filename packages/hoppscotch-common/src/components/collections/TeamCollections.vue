...
const emit = defineEmits<{
  ...
  (event: "export-openapi", payload: TeamCollection): void
  (event: "export-swagger-ui", payload: TeamCollection): void
  (event: "export-markdown", payload: TeamCollection): void
  (event: "export-custom-html", payload: TeamCollection): void
  (event: "export-custom-html-sidebar", payload: TeamCollection): void
