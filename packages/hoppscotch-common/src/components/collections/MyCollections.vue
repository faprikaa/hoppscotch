      ...
      <HoppSmartTree :adapter="myAdapter">
        ...
        >
          <CollectionsCollection
            ...
            @export-swagger-ui="
              node.data.type === 'collections' &&
                emit('export-swagger-ui', node.data.data.data)
            "
            @export-markdown="
              node.data.type === 'collections' &&
                emit('export-markdown', node.data.data.data)
            "
            @export-custom-html="
              node.data.type === 'collections' &&
                emit('export-custom-html', node.data.data.data)
            "
            @export-custom-html-sidebar="
              node.data.type === 'collections' &&
                emit('export-custom-html-sidebar', node.data.data.data)
            "
            @export-docusaurus="
              node.data.type === 'collections' &&
                emit('export-docusaurus', node.data.data.data)
            "
...
const emit = defineEmits<{
  ...
  (event: "export-swagger-ui", payload: HoppCollection): void
  (event: "export-markdown", payload: HoppCollection): void
  (event: "export-custom-html", payload: HoppCollection): void
  (event: "export-custom-html-sidebar", payload: HoppCollection): void
  (event: "export-docusaurus", payload: HoppCollection): void
