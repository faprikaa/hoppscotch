              ...
              <template #content="{ hide }">
                ...
                >
                  ...
                  <HoppSmartItem
                    ref="exportSwaggerUI"
                    :icon="IconCode"
                    :label="t('export.as_swagger_ui')"
                    :loading="exportLoading"
                    @click="
                      () => {
                        emit('export-swagger-ui')
                        hide()
                      }
                    "
                  />
                  ...
                  />
                  <HoppSmartItem
                    ref="exportCustomHTML"
                    :icon="IconFileText"
                    :label="t('export.as_custom_html')"
                    :loading="exportLoading"
                    @click="
                      () => {
                        emit('export-custom-html')
                        hide()
                      }
                    "
                  />
                  <HoppSmartItem
                    ref="exportCustomHTMLSidebar"
                    :icon="IconFileText"
                    :label="t('export.as_html_with_sidebar')"
                    @click="
                      () => {
                        emit('export-custom-html-sidebar')
                        hide()
                      }
                    "
                  />
                  <HoppSmartItem
                    ref="exportDocusaurus"
                    :icon="IconFileText"
                    :label="t('export.as_docusaurus')"
                    :loading="exportLoading"
                    @click="
                      () => {
                        emit('export-docusaurus')
                        hide()
                      }
                    "
                  />
...
const emit = defineEmits<{
  ...
  (event: "export-swagger-ui"): void
  (event: "export-markdown"): void
  (event: "export-custom-html"): void
  (event: "export-custom-html-sidebar"): void
  (event: "export-docusaurus"): void
